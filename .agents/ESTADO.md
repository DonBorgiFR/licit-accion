...
| | |
|---|---|
| **Suite** | **754/754** *(742 al empezar el día, +12 regresiones del bloque 10.B.3)* |
| **Plan del bloque 10.B.3** | [`PLAN_10B3.md`](PLAN_10B3.md) — validado **y ejecutado** el 2026-09-01. Contrato en **v1.4.0** |
| **Código tocado** | `src/rastro.py`, `src/api/dependencies.py`, `src/api/routers/admin.py`, `src/diagnostico.py` |
